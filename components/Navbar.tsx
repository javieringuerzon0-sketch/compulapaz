      ...
      <div className="container mx-auto px-6 h-full flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a 
            ...
            className="text-text-secondary hover:text-accent-cyan transition-colors font-bold text-sm uppercase tracking-wide"
          >
            Servicios
          </a>
          <a 
            ...
            className="text-text-secondary hover:text-accent-purple transition-colors font-bold text-sm uppercase tracking-wide"
          >
            Diagnóstico AI
          </a>
          <a 
